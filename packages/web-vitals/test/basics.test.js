...
describe('Web Vitals integration basics', () => {
				...
				body: JSON.stringify([
					{
						...
						route: '/',
						name: 'CLS',
						id: 'v5-1711484350895-3748043125387',
						value: 0,
						rating: 'good',
					},
				]),
	...
	it('inserted data uses a truncated timestamp in the ID', async () => {
		...
		// e.g. 'v5-1711484350895-3748043125387'. We reduce this data to an hourly resolution to lessen privacy concerns.
		const dbRows = await fixture.fetch('/rows.json', {}).then((r) => r.json());
		assert.deepEqual(dbRows[0].id, 'v5-17114843-3748043125387');
	});
});
